        ...
        <Disclosure as='nav' className='max-w-7xl py-1 px-5 mx-auto'>
            <div className='flex justify-between items-center'>
                ...
                <div className='hidden sm:block flex space-x-12'>
                    <Link to="/" className='text-lg hover:border-gray-700 border-transparent border-b-2 hover:border-current'>Home</Link>
                    <Link to="/about" className='text-lg hover:border-gray-700 border-transparent border-b-2 hover:border-current'>About</Link>
                    <Link to="/contact" className='text-lg hover:border-gray-700 border-transparent border-b-2 hover:border-current'>Contact</Link>
                </div>
